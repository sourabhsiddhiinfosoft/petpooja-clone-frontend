...
class SocketService {
   ...
   */
  getSocketURL() {
    // Prefer explicit SOCKET URL, then API URL, then sensible local fallback
    const explicitSocket = process.env.NEXT_PUBLIC_SOCKET_URL;
    ...
    // If running in browser and on localhost, default to local backend
    ...
    // Production default (kept as last resort)
    return 'https://petpooja-clone-backend.vercel.app';
  }
